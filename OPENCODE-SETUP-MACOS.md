...
Ollama runs AI models on your own Mac — free, private, and offline. It is a good way to test the setup before paying for anything.

1. Download from https://ollama.com/download and install like any Mac app.
2. In Terminal: `ollama pull qwen2.5-coder:7b` (downloads a small coding model).
